...
export default function Detail (){
    ...
    const msg = `Olá ${incident.name}, gostaria de contribuir no caso ${incident.title} com o valor de ${Intl.NumberFormat('pt-BR', {style: 'currency', currency: 'BRL' }).format(incident.value)} `;
